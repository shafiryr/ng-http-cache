...
export interface MutationOptions<TData, TVariables, TContext = unknown> {
    ...
    onError?: (error: HttpQueryError, variables: TVariables, context: TContext | undefined) => void | Promise<void>;
    onFinally?: (data: TData | null, error: HttpQueryError | null, variables: TVariables, context: TContext | undefined) => void | Promise<void>;
